<template>
  <main class="page about">
    ...
    <p>
      ...
      <a href="https://github.com/tortitast" target="_blank">Github</a> to see
      all my work.
    </p>

    <p>
      I work as a junior developer at
      <a href="https://descom.es" target="_blank">Descom.es</a>, a software
      company from La Nucia, Spain. There I work with
    ...
    <p>
      ...
      <a href="https://tortitas.itch.io/" target="_blank">itch.io</a> profile.
      As for my miscellaneous projects, you can check them out on my
      <a href="https://github.com/tortitast" target="_blank">Github</a>
    </p>
  </main>
</template>
